/*
  # Fix Get All Punchlist Customers - Correct Table Name

  1. Changes
    - Use correct table name: recurring_subscriptions (not subscriptions)
    - This will allow the function to properly return VIP members and all access types
*/
