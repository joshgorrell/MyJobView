/*
  # Fix Revision Function - Correct Column Names
  
  1. Changes
    - Use correct column name: unit_price (not price)
    - Add missing columns: line_total, labor_total, is_taxable, tax_amount, item_class, labor_phase, show_task_notes, class_id, labor_phase_id
    - Ensures all line item data is properly copied to revisions
*/
