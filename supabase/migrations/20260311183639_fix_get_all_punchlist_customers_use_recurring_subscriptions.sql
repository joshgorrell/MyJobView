/*
  # Fix get_all_punchlist_customers - use correct table name

  ## Summary
  The previous migration used `subscriptions` which does not exist.
  The correct table name is `recurring_subscriptions`.

  ## Changes
  - Drops and recreates `get_all_punchlist_customers()` with the correct
    table reference: `recurring_subscriptions` instead of `subscriptions`
*/
