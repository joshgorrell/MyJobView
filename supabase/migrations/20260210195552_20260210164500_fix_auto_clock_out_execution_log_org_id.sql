/*
  # Fix Auto Clock-Out Execution Log Organization ID
  
  1. Issue
    - The auto_clock_out_execution_log table has organization_id as NOT NULL
    - The default uses get_user_org_id() which fails in SECURITY DEFINER functions
    - This causes the auto_clock_out_forgotten_entries() function to fail
  
  2. Fix
    - Update the auto_clock_out_forgotten_entries() function to explicitly set organization_id
    - The function already gets the org_id from the organizations table
*/
