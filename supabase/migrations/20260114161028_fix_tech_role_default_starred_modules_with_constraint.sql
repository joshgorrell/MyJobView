/*
  ...
  1. Changes
    - Add 'tech' to the module_role_access role check constraint
...
DROP CONSTRAINT IF EXISTS module_role_access_role_check;

-- Recreate the constraint with 'tech' included
ALTER TABLE module_role_access
ADD CONSTRAINT module_role_access_role_check 
CHECK (role IN ('admin', 'sales', 'bd', 'project_manager', 'technician', 'tech', 'office_manager', 'field_tech', 'portal_user'));
