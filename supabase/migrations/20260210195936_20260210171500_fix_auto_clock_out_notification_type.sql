/*
  # Fix Auto Clock-Out Notification Type
  
  1. Issue
    - Using 'auto_clock_out_completed' type which doesn't exist
    - Valid type is 'auto_clock_out'
  
  2. Fix
    - Change notification type to 'auto_clock_out'
*/
