/*
  # Fix Invoice Line Items Column Name

  ## Problem
  The handle_unified_proposal_approval() function was using the wrong column name
  for invoice line items. It was using "taxable" but the actual column is "is_taxable".

  ## Solution
  Update the function to use the correct column name: is_taxable

  ## Changes
  - Fix both INSERT statements for invoice_line_items to use is_taxable instead of taxable
*/
