/*
  # Fix Revision to Copy All Proposal Settings

  1. Purpose
    - Update create_proposal_revision to copy ALL proposal_settings fields
    - Includes pricing modifiers: discount, fees, custom modifiers
    - Ensures revisions display accurate pricing details in footer
    
  2. Changes
    - Updates the proposal_settings INSERT in create_proposal_revision
    - Adds all missing modifier and configuration fields
*/
...
BEGIN
  ...
  -- Copy ALL proposal settings including pricing modifiers
  INSERT INTO proposal_settings (
    ...
    overall_scope_of_work,
    contract_terms,
    deposit_terms,
    show_deposit_terms_in_proposal,
    show_contract_terms_in_proposal,
    show_overall_scope_in_proposal,
    show_modifiers_in_proposal
  )
  SELECT
    v_new_proposal_id,
    logo_url,
