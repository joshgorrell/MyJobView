...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = 'work_orders' AND table_schema = 'public' AND column_name = 'scheduled_date'
  ) THEN
...
CREATE INDEX IF NOT EXISTS idx_work_orders_assigned_scheduled
  ON work_orders (assigned_to, scheduled_date);
