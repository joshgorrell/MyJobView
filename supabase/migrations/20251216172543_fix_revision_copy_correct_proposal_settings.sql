/*
  # Fix Revision to Copy Correct Proposal Settings

  1. Purpose
    - Update create_proposal_revision to copy only existing proposal_settings fields
    - Includes all pricing modifiers and display settings
    
  2. Changes
    - Uses only columns that exist in proposal_settings table
    - Ensures revisions display accurate pricing details
*/
...
BEGIN
  ...
  -- Copy ALL proposal settings with correct column names
