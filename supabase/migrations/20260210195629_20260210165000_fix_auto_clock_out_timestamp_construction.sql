/*
  # Fix Auto Clock-Out Timestamp Construction
  
  1. Issue
    - The cutoff timestamp construction is creating invalid timestamps
    - Concatenating CURRENT_DATE with time is producing "2026-02-09 00:00:00 22:00:00"
    - This causes the function to fail with "invalid input syntax for type timestamp"
  
  2. Fix
    - Use proper date + time construction
    - Cast CURRENT_DATE to text in YYYY-MM-DD format before concatenation
*/
