/*
  # Fix Auto Clock-Out award_points() Call
  
  1. Issue
    - The function is calling award_points() with 4 parameters
    - The actual function only takes 3 parameters: user_id, points, reason
  
  2. Fix
    - Update the function call to use correct signature
    - Remove the 'auto_clock_out_penalty' type parameter
*/
