/*
  # Fix Missing Top Performers Function

  1. New Functions
    - `get_top_performers` - Returns top performing technicians based on completions and quality

  2. Details
    - Calculates metrics for the specified time period (days)
    - Returns completion count, average quality score, and photo count
    - Orders by completion count descending
    - Limited to active technicians with at least one completion
*/
